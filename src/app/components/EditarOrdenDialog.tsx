			...
			<Dialog header="Editar Orden" visible={visible} onHide={onHide} style={{ width: "60vw" }}>
				...
				<div className="p-6 space-y-6">
					...
					<div className="rounded-lg mb-4">
						<div className="bg-gray-100/60 rounded-t px-4 py-2">
							<h4 className="font-bold text-blue-700">Fase 1: Solicitud Inicial</h4>
						</div>
						<div className="bg-gray-50 p-4 rounded-b grid grid-cols-2 md:grid-cols-3 gap-3 text-gray-700">
							<label className="col-span-2 text-xs font-semibold text-gray-600">Descripción</label>
					...
					<div className="rounded-lg mb-4">
						<div className="bg-gray-100/60 rounded-t px-4 py-2">
							<h4 className="font-bold text-green-700">Fase 2: Emisión</h4>
						</div>
						<div className="bg-gray-50 p-4 rounded-b grid grid-cols-2 md:grid-cols-3 gap-3 text-gray-700">
					...
					<div className="rounded-lg mb-4">
						<div className="bg-gray-100/60 rounded-t px-4 py-2">
							<h4 className="font-bold text-yellow-700">Fase 3: Recepción</h4>
						</div>
						<div className="bg-gray-50 p-4 rounded-b grid grid-cols-2 md:grid-cols-3 gap-3 text-gray-700">
					...
					<div className="rounded-lg mb-4">
						<div className="bg-gray-100/60 rounded-t px-4 py-2">
							<h4 className="font-bold text-purple-700">Fase 4: Facturación</h4>
						</div>
						<div className="bg-gray-50 p-4 rounded-b grid grid-cols-2 md:grid-cols-3 gap-3 text-gray-700">
					...
					<div className="rounded-lg mb-4">
						<div className="bg-gray-100/60 rounded-t px-4 py-2">
							<h4 className="font-bold text-pink-700">Fase 5: Entrega</h4>
						</div>
						<div className="bg-gray-50 p-4 rounded-b grid grid-cols-2 md:grid-cols-3 gap-3 text-gray-700">
					...
					<div className="rounded-lg mb-4">
						<div className="bg-gray-100/60 rounded-t px-4 py-2">
							<h4 className="font-bold text-gray-700">Otros campos</h4>
						</div>
						<div className="bg-gray-50 p-4 rounded-b grid grid-cols-2 gap-4">
